...
@section('content')
    <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">@lang('lang.:name Update', ['name' => __('lang.Farmer')])</h4>
                    <form id="farmerUpdate" action="{{ route('user.farmers.update', $farmer->farmer_id) }}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group @error('father_name') has-danger @enderror">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('father_name') ?? $farmer->father_name }}" name="father_name">
                                    @error('father_name')
                            ...
                            <div class="col-md-6">
                                <div class="form-group @error('email') has-danger @enderror">
                                    ...
                                    <input type="email"
                                        ...
                                        placeholder="emaple@gmail.com" value="{{ old('email') ?? $farmer->email }}"
                                        name="email">
                                    @error('email')
                            ...
                            <div class="col-md-6">
                                <div class="form-group @error('mobile') has-danger @enderror">
                                    ...
                                    <input type="number" min="0"
                                        ...
                                        placeholder="@lang('lang.Mobile No.')" value="{{ old('mobile') ?? $farmer->mobile }}"
                                        name="mobile">
                                    @error('mobile')
                        ...
                        <div class="row" id="advanceOption" @if(old('is_fixed_rate')) style="" @elseif ($farmer->is_fixed_rate == 1) style=""  @else style="display: none" @endif>
                            <div class="col-md-6">
                                <div class="row my-2">
                                    <label class="col-sm-9 col-form-label">@lang('lang.Fixed Rate')</label>
                                    <label class="col-sm-3 checkbox-inline">
                                        <input type="checkbox" data-style="quick" name="is_fixed_rate" @checked($farmer->is_fixed_rate)
                            ...
                            <div class="col-md-6">
                                <div class="row my-2">
                                    ...
                                    <label class="col-sm-3 checkbox-inline">
                                        <input type="checkbox" data-style="quick" name="fixed_rate_type"   @if(old('fixed_rate_type') == 'on') checked  @elseif($farmer->fixed_rate_type == 1) checked @endif
                            ...
                            <div class="col-md-6">
                                <div class="form-group @error('fat_rate') has-danger @enderror">
                                    ...
                                    <input type="number" min="0"
                                        ...
                                        placeholder="@lang('lang.Fat Rate Value.')" step="0.01" value="{{ old('fat_rate') ?? $farmer->fat_rate }}"
                                        name="fat_rate">
                                    @error('fat_rate')
                                        <label id="fat_rate-error" class="error mt-2 text-danger"
                                            for="fat_rate">{{ $message }}</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group @error('rate') has-danger @enderror">
                                    ...
                                    <input type="number" min="0"
                                        ...
                                        placeholder="@lang('lang.Fixed Rate Value.')" step="0.01" value="{{ old('rate') ?? $farmer->rate }}"
                                        name="rate">
                                    @error('rate')
                        ...
                        <button type="submit" class="btn btn-primary mr-2">@lang('lang.:name Update', ['name' => __('lang.Farmer')])</button>
                        <a href="{{ route('user.farmers.list') }}" class="btn btn-light mr-2">@lang('lang.Back')</a>
                    </form>
