...
@section('content')
    <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">@lang('lang.Add New :name', ['name' => __('lang.Farmer')])</h4>
                    <form id="farmerAdd" action="{{ route('user.farmers.store') }}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <button type="submit" class="btn btn-primary mr-2">@lang('lang.Add :name', ['name' => __('lang.Farmer')])</button>
                    </form>
