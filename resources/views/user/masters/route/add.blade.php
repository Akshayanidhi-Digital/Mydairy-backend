...
@section('content')
    <div class="row">
        <div class="col-md-12 grid-margin">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('user.masters.routes.store') }}" method="post">
                        @csrf
                        <div class="form-group @error('transporter') has-danger @enderror">
                            ...
                            <select class="transporter_select w-100 @error('transporter') form-control-danger @enderror"
                                ...
                                @foreach ($transporter as $data)
                                    <option @if (old('transporter') && old('transporter') == $data->transporter_id) selected @endif
                        ...
                        <div class="form-group @error('route_name') has-danger @enderror">
                            ...
                            <input type="text" min="0"
                                ...
                                placeholder="@lang('lang.Name')" value="{{ old('route_name') }}" name="route_name">
                            @error('route_name')
                        ...
                        <div id="dairy-list-container">
                            @php
                                $oldDairyList = old('dairy_list', []);
                                $countOldDairyList = count($oldDairyList);
                        ...
                        <button type="submit" class="btn btn-primary me-2">@lang('lang.Add :name', ['name' => __('lang.Route')])</button>
