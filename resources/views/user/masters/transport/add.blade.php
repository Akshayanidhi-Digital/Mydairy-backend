...
@section('content')
    <div class="row">
        <div class="col-md-12 grid-margin">
            <div class="card">
                <div class="card-body">
                    <form id="transporteradd" action="{{route('user.masters.transport.store')}}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group @error('transport_name') has-danger @enderror">
                                    <label for="transport_name">@lang('lang.transport_name')</label>
                                    <input type="text" class="form-control @error('transport_name') form-control-danger @enderror"
                        ...
                        <button type="submit" class="btn btn-primary me-2">@lang('lang.Add :name', ['name' => __('lang.Transporter')])</button>
