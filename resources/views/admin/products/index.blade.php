                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('admin.products.add') }}" type="button"
                            class="btn btn-primary">@lang('lang.Add :name', ['name' => __('lang.Product')])</a>
                    </div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                @if ($products->total() > 0)
                                    ...
                                    @endforeach
                                    @if ($products->total() > env('PER_PAGE_RECORDS'))
                                        <tr>
                                            <td colspan="10">
                                ...
                                @else
                                    <tr>
                                        <th colspan="10"><span class="w-100 text-center">No records found</span></th>
                                    </tr>
                                @endif
                            </tbody>
                        </table>
        ...
        (function($) {
            ...
            $.contextMenu({
                ...
                callback: function(key, options) {
                    ...
                    switch (key) {
                        case 'edit':
                            var urlEdit = '{{ route('admin.products.edit', ':id') }}';
