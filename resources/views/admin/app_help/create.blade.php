        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.apphelp.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" accept="image/png, image/jpeg, image/jpeg" name="help_image" class="dropify">
                            @error('help_image')
                                <label id="help_image-error" class="error mt-2 text-danger"
                                    for="help_image">{{ $message }}</label>
                            @enderror
                        </div>
                        <button class="btn btn-primary">Add Help</button>
