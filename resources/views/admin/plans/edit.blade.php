                ...
                <div class="card-body">
                    ...
                    <form action="{{route('admin.plans.update',$plan->id)}}" method="post" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="plan_name" value="{{old('plan_name')?? $plan->name}}">
                                @error('plan_name')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control" name="category">
                                    ...
                                    selected @elseif($plan->category == 'single')selected
                                @endif  value="single">Single</option>
                                    <option @if (old('category') == 'multiple')
                                    selected @elseif($plan->category == 'multiple')selected
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" min="0" class="form-control" name="user_allowed" value="{{old('user_allowed') ?? $plan->user_count}}">
                                @error('user_allowed')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" min="0" class="form-control" name="farmer_count" value="{{old('farmer_count') ?? $plan->farmer_count}}">
                                @error('farmer_count')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" min="0" step="0.01" class="form-control" name="price" value="{{old('price') ?? $plan->price}}">
                                @error('price')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" min="0"  class="form-control" name="duration" value="{{old('duration') ?? $plan->duration}}">
                                @error('duration')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control" name="duration_type">
                                    ...
                                    selected @elseif($plan->duration_type == 'day')selected
                                @endif  value="day">Days</option>
                                <option @if (old('duration_type') == 'month')
                                    selected @elseif($plan->duration_type == 'month')selected
                                @endif  value="month">Month</option>
                                <option @if (old('duration_type') == 'year')
                                    selected @elseif($plan->duration_type == 'year')selected
