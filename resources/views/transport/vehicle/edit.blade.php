...
@section('content')
    <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">@lang('lang.:name Update', ['name' => 'Driver'])</h4>
                    <form id="childDairy" action="{{ route('transport.vehicle.update',$vehicle->id) }}" method="POST" autocomplete="off">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group @error('driver') has-danger @enderror">
                                    ...
                                    <select class="driver_select w-100 @error('driver') form-control-danger @enderror"
                                        ...
                                        @foreach ($drivers as $driver)
                                            <option @if (old('driver',$vehicle->driver_id) == $driver->driver_id) selected @endif
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="vehicle_number"
                                        value="{{ old('vehicle_number',$vehicle->vehicle_number) }}" style='text-transform:uppercase' name="vehicle_number"
                            ...
                            <div class="col-md-6">
                                <div class="form-group @error('quantity') has-danger @enderror">
                                    ...
                                    <input type="number"
                                        ...
                                        id="quantity" placeholder="Quantity" value="{{ old('quantity',$vehicle->capacity) }}"
                                        name="quantity">
                                    @error('quantity')
                                ...
                                <div class="form-group @error('unit_type') has-danger @enderror">
                                    ...
                                    <select class="unit_type_select w-100 @error('unit_type') form-control-danger @enderror"
                                        ...
                                        @foreach (VEHICLE_UNIT as $unit_type)
                                            <option @if (old('unit_type',$vehicle->unit) == $unit_type) selected @endif
