        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="childDairy" action="{{ route('transport.driver.update',$driver->driver_id) }}" method="POST" autocomplete="off">
                        @csrf
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="name">@lang('lang.Name')</label>
                                    <input type="text" class="form-control" id="name" value="{{ old('name',$driver->name) }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group @error('father_name') has-danger @enderror">
                                    ...
                                    <input type="text"
                                        ...
                                        id="father_name" placeholder="@lang('lang.Father Name')" value="{{ old('father_name',$driver->father_name) }}"
                                        name="father_name">
                                    @error('father_name')
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" id="email" value="{{ old('email',$driver->email) }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group @error('country_code') has-danger @enderror">
                                    ...
                                    <select
                                        ...
                                        <option @if(old('country_code',$driver->country_code) == '+91') selected  @endif value="+91">@lang('lang.India')</option>
                                    </select>
                                </div>
                                @error('country_code')
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" value="{{ old('mobile',$driver->mobile) }}" id="mobile"
                        ...
                        <button type="submit" class="btn btn-primary me-2">@lang('lang.:name Update', ['name' => 'Driver'])</button>
